...
{	
    ...
    public function exp(Request $request)
    {
        ...
        while(true){
            ...
            $models = \App\Model1\MoneyLog::where('add_time', '>=', strtotime("2020-06-01 02:00:00"))->where('add_time', '<=', strtotime("2020-07-01 00:00:00"))->where('id', '>', $maxId)->limit($speed)->orderBy('id', 'asc')->get();
